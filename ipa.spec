...
Source5:	ipa-spec-debrand.patch
Source6:	ipa-spec-fix-osrelease.patch
Source7:	ipa.ini
Source8:	os-name-white.png
Source9:	os-name-white-big.png
...
BuildRequires:  scientific-linux-logos >= 70.0.3-0.8.el7
...
#
BuildRequires:  python-ldap >= %{python2_ldap_version}
...
BuildRequires:  python3-ldap >= %{python3_ldap_version}
%endif # with_python3
%endif # with_lint
...
Requires(pre): python3-ldap >= %{python3_ldap_version}
...
cp %{_sourcedir}/os-name-white.png install/ui/images/header-logo.png
cp %{_sourcedir}/login-screen-background.jpg install/ui/images/login-screen-background.jpg
cp %{_sourcedir}/login-screen-logo.png install/ui/images/login-screen-logo.png
cp %{_sourcedir}/os-name-white-big.png install/ui/images/product-name.png
...
%changelog
* Mon Dec 23 2019 Aleksander Baranowski <aleksander.baranowski@euro-linux.com> - 4.6.5-12
- Changes for new build system.

* Wed Aug 28 2019 Cezary Drak <cd@euro-linux.com> - 4.6.5-11.el7_7.1
- Pull from upstream
...
* Wed Aug  7 2019 Aleksander Baranowski <aleksander.baranowski@euro-linux.com> - 4.6.4-10.el7_6.6
- Pull from upstream
...
- Built with EuroLinux De/Rebranding
...
* Fri Mar  15 2019 Aleksander Baranowski <aleksander.baranowski@euro-linux.com> - 4.6.4-10.el7_6.3
- Rebuild with EuroLinux Branding
...
* Mon Jun 11 2018 Florence Blanc-Renaud <frenaud@redhat.com> - 4.6.4-1.el7
...
- Resolves: #1483139 ipa-restore command doesn't exit with failure if wrong directory manager's password is provided
...
- Resolves: #1504565 API schema generated by server doesn't follow language requested by client.
